-- CREDITS TO: https://github.com/mkafrin/PolyZone
-- to minimize unnecessary dependencies, poly zone script has been adapted and modified for devhub_lib

eventPrefix = 'devhub_lib__PolyZone__:'
PolyZone = {}
